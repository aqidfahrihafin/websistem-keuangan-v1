...
<ul>
    ...
    <li>Setoran tunai admin di <code>/admin/transaksi/verifikasi</code> menampilkan nama santri dan nominal Rupiah pada modal konfirmasi sebelum memanggil <code>WalletService::credit()</code>. Tombol proses dikunci selama request berjalan, lalu setiap pencarian, validasi, keberhasilan, atau kegagalan menampilkan alert di dalam komponen Livewire (bukan hanya session flash pada layout).</li>
